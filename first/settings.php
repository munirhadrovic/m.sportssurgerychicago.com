<?php
	$adresa="1611 West Harrison Street Chicago, Illinois 60612"; //jako je vazno navesti dobro adresu radi boljeg poziciniranja
	$grad="";//jako je vazno ako adresa ima dva imena povezati ih sa plus
	$skracenica=""; // AKo ne znate skracenicu ostavite praznu
	$telephone=7082362701;// Broj koji se poziva na dugme CALL US
